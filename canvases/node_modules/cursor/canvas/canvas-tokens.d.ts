 ...
 * There is no `colors` bag — `theme.colors.bg.primary` is not a path.
 * Use `theme.bg.editor`, `theme.fill.primary`, `theme.text.primary`,
 * `theme.stroke.secondary`, `theme.accent.primary`.
 */
